...
public class SphereScriptUnaryExpressionImpl extends ASTWrapperPsiElement implements SphereScriptUnaryExpression {

  public SphereScriptUnaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SphereScriptPrimaryExpression getPrimaryExpression() {
    return findNotNullChildByClass(SphereScriptPrimaryExpression.class);
  }
