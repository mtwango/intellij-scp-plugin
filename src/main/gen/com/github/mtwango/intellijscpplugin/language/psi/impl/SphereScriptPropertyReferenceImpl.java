...
public class SphereScriptPropertyReferenceImpl extends ASTWrapperPsiElement implements SphereScriptPropertyReference {

  public SphereScriptPropertyReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
