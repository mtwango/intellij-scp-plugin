...
public class SphereScriptSectionBodyImpl extends ASTWrapperPsiElement implements SphereScriptSectionBody {

  public SphereScriptSectionBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SphereScriptVisitor visitor) {
    visitor.visitSectionBody(this);
  }
  ...
  @Override
  @NotNull
  public List<SphereScriptCommentRule> getCommentRuleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SphereScriptCommentRule.class);
  }

  @Override
  @NotNull
  public List<SphereScriptProperty> getPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SphereScriptProperty.class);
  }
