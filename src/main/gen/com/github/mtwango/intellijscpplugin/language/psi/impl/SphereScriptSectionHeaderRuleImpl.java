...
public class SphereScriptSectionHeaderRuleImpl extends ASTWrapperPsiElement implements SphereScriptSectionHeaderRule {

  public SphereScriptSectionHeaderRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SphereScriptVisitor visitor) {
    visitor.visitSectionHeaderRule(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getSectionHeader() {
    return findNotNullChildByType(SECTION_HEADER);
  }
