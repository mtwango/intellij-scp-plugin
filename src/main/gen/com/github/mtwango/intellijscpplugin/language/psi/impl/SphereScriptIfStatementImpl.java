...
public class SphereScriptIfStatementImpl extends ASTWrapperPsiElement implements SphereScriptIfStatement {

  public SphereScriptIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
