...
public class SphereScriptContinueStatementImpl extends ASTWrapperPsiElement implements SphereScriptContinueStatement {

  public SphereScriptContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
