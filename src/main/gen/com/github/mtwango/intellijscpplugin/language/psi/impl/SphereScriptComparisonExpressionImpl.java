...
public class SphereScriptComparisonExpressionImpl extends ASTWrapperPsiElement implements SphereScriptComparisonExpression {

  public SphereScriptComparisonExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SphereScriptAdditiveExpression> getAdditiveExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SphereScriptAdditiveExpression.class);
  }
