...
public class SphereScriptPropertyValueImpl extends ASTWrapperPsiElement implements SphereScriptPropertyValue {

  public SphereScriptPropertyValueImpl(@NotNull ASTNode node) {
    super(node);
  }
