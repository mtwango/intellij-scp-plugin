...
public class SphereScriptAdditiveExpressionImpl extends ASTWrapperPsiElement implements SphereScriptAdditiveExpression {

  public SphereScriptAdditiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SphereScriptMultiplicativeExpression> getMultiplicativeExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SphereScriptMultiplicativeExpression.class);
  }
