...
public class SphereScriptExpressionImpl extends ASTWrapperPsiElement implements SphereScriptExpression {

  public SphereScriptExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SphereScriptLogicalOrExpression getLogicalOrExpression() {
    return findNotNullChildByClass(SphereScriptLogicalOrExpression.class);
  }
