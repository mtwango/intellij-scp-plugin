...
public class SphereScriptLogicalOrExpressionImpl extends ASTWrapperPsiElement implements SphereScriptLogicalOrExpression {

  public SphereScriptLogicalOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SphereScriptLogicalAndExpression> getLogicalAndExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SphereScriptLogicalAndExpression.class);
  }
