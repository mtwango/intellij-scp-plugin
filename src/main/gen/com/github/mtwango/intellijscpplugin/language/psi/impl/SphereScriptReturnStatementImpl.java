...
public class SphereScriptReturnStatementImpl extends ASTWrapperPsiElement implements SphereScriptReturnStatement {

  public SphereScriptReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
