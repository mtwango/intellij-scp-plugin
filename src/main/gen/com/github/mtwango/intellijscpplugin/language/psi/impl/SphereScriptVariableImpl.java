...
public class SphereScriptVariableImpl extends ASTWrapperPsiElement implements SphereScriptVariable {

  public SphereScriptVariableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SphereScriptVariablePath getVariablePath() {
    return findNotNullChildByClass(SphereScriptVariablePath.class);
  }
