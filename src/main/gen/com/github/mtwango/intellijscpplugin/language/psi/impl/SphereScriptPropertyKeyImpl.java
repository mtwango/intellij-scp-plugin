...
public class SphereScriptPropertyKeyImpl extends ASTWrapperPsiElement implements SphereScriptPropertyKey {

  public SphereScriptPropertyKeyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SphereScriptKeywordAsProperty getKeywordAsProperty() {
    return findChildByClass(SphereScriptKeywordAsProperty.class);
  }
