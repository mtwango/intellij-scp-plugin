...
public class SphereScriptKeywordAsPropertyImpl extends ASTWrapperPsiElement implements SphereScriptKeywordAsProperty {

  public SphereScriptKeywordAsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SphereScriptVisitor visitor) {
    visitor.visitKeywordAsProperty(this);
  }
