...
public class SphereScriptMultiplicativeExpressionImpl extends ASTWrapperPsiElement implements SphereScriptMultiplicativeExpression {

  public SphereScriptMultiplicativeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SphereScriptUnaryExpression> getUnaryExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SphereScriptUnaryExpression.class);
  }
