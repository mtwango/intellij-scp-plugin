...
public class SphereScriptBreakStatementImpl extends ASTWrapperPsiElement implements SphereScriptBreakStatement {

  public SphereScriptBreakStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
